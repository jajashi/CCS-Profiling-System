...
const Sidebar = () => {
  ...
  const [openGroup, setOpenGroup] = useState(() =>
    resolveOpenGroup(location.pathname),
  );
  ...
  const isInstructionSectionActive =
    location.pathname.startsWith(INSTRUCTION_PREFIX);
  const isSchedulingSectionActive =
    ...
    <aside className="sidebar">
      <div className="sidebar-header">
        <div className="sidebar-logo">
          ...
          />
          <span style={{ display: "none" }} className="text-logo">
            CCS
          </span>
        </div>
        ...
        <ul className="nav-list">
          ...
          {isStudent ? (
            <>
              <li className="nav-item">
                <NavLink
                  to={`/dashboard/student-info/${user?.studentId || ""}`}
                  className={({ isActive }) =>
                    isActive ? "nav-link active" : "nav-link"
                  }>
                  <span className="nav-icon">
            ...
            <>
              ...
              <li
                className={`nav-item nav-group${instructionNavOpen ? " nav-group--open" : ""}`}>
                <button
                  type="button"
                ...
                {instructionNavOpen ? (
                  <ul
                    ...
                    id="sidebar-faculty-instruction-subnav"
                    role="list">
                    <li className="nav-subitem">
                      <NavLink
                        ...
                        <span className="nav-icon nav-sublink-icon">
                          <FiBookOpen />
                        </span>
            ...
            <>
              ...
              <li
                className={`nav-item nav-group${facultyNavOpen ? " nav-group--open" : ""}`}>
                <button
                  type="button"
              ...
              <li
                className={`nav-item nav-group${schedulingNavOpen ? " nav-group--open" : ""}`}>
                <button
                  type="button"
                ...
                {schedulingNavOpen ? (
                  <ul
                    ...
                    <li className="nav-subitem">
                      <NavLink
                        to="/dashboard/scheduling/analytics"
                        end
                        className={({ isActive }) =>
                          isActive
                            ? "nav-link nav-sublink active"
                        ...
                        <span className="nav-text">Scheduling Analytics</span>
                      </NavLink>
                    </li>
                    <li className="nav-subitem">
                      <NavLink
      ...
      <div className="sidebar-footer">
        {isFaculty && !isAdmin ? (
          <NavLink
            ...
            className={({ isActive }) =>
              isActive
                ? "nav-link sidebar-footer-link active"
                : "nav-link sidebar-footer-link"
            }>
            <span className="nav-icon">
              <FiUser />
            </span>
