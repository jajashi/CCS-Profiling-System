...
import { FiBriefcase, FiEdit2, FiInfo, FiMail, FiPhone, FiPlus, FiSearch, FiTrash2, FiUserCheck, FiUsers, FiX, FiPower, FiChevronLeft, FiChevronRight, FiFilter, FiChevronDown, FiChevronUp, FiLoader } from 'react-icons/fi';
...
const FacultyInformation = () => {
  ...
  const toggleStatus = async (member) => {
    ...
    if (newStatus === 'Inactive') {
      reason = window.prompt("Please provide a reason for deactivating this faculty member:");
    ...
    try {
      ...
      const payload = {
        ...
        status: newStatus,
        inactiveReason: newStatus === 'Inactive' ? reason : '',
